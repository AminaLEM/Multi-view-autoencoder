...
class MutiViewAutoencoder():
    ...
    '''
    def __init__(self,data1, data2, data3,testdata1=None,testdata2=None,testdata3= None, n_hiddensh=4, activation=tf.nn.relu):
...
#        train the HP optimization with 50 iterations
          ...
          fname = './GBM_trials_HPMV8evals500_tanhu.pkl'
...
#        save the best HPs
          ...
          f= open('./GBM_MVGBMparameter500_tanhu.txt', 'a+')
