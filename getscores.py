...
#             get the loss of training the model on test data
        ...
        if mrna_nbr >2 or cnv_nbr >2 or miRNA_nbr>2:
          ...
          if  mrna_nbr >1:
                  ...
                  fig = plt.figure()        
                  shap.summary_plot(shapfeat[0][0], mrna_sel_data,feature_names =nameFmrna, title= " (mRNA)", plot_type="bar")
                  fig.savefig('./' + 'mrna'+'.png',bbox_inches = 'tight')
                  ...
                  if cnv_nbr >1:
                      fig = plt.figure()        
                      shap.summary_plot(shapfeat[0][1], cnv_sel_data,feature_names =nameFcnv, title= " (CNV)", plot_type="bar")
                      fig.savefig('./' + 'cnv'+'.png',bbox_inches = 'tight')
                      ...
                      if miRNA_nbr>1:
                          fig = plt.figure()        
                          shap.summary_plot(shapfeat[0][2],miRNA_sel_data,feature_names =nameFmi, title= " (miRNA)", plot_type="bar")
